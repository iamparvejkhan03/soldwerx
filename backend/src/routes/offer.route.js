...
offerRouter.get('/admin/all', authAdmin, requirePermission("manage_offers"), getAdminAllOffers);
offerRouter.get('/admin/auction/:auctionId', authAdmin, requirePermission("manage_offers"), getAdminAuctionOffers);
offerRouter.post('/admin/:offerId/respond', authAdmin, requirePermission("manage_offers"), adminRespondToOffer);
offerRouter.post('/admin/:offerId/cancel', authAdmin, requirePermission("manage_offers"), adminCancelOffer);
offerRouter.get('/admin/stats', authAdmin, requirePermission("manage_offers"), getAdminOfferStats);
offerRouter.post('/admin/:offerId/end-auction', authAdmin, requirePermission("manage_offers"), adminEndAuctionWithOffer);
