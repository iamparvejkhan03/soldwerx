...
bidRouter.get('/admin/history', authAdmin, requirePermission("manage_bids"), getAdminBidHistory);
bidRouter.get('/admin/stats', authAdmin, requirePermission("manage_bids"), getAdminBidStats);
