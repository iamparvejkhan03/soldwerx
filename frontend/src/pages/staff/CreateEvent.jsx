...
// Available Auctions Component - Staff sees ALL auctions
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md mx-4">
                <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold">Creating Event</h3>
                </div>
...
function CreateEvent() {
    ...
    // Fetch all auctions (staff sees all)
    useEffect(() => {
                ...
                <div className="w-full relative">
                    ...
                    <StaffContainer>
                        <div className="pt-16 md:py-7">
                            <h1 className="text-3xl md:text-4xl font-bold mb-5">Create Event (Staff)</h1>
                            <p className="text-gray-600 mb-8">Create a new auction event and assign auctions from any seller</p>
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-4">
                                            <p className="text-gray-600">
                                                ...
                                                As staff, you can see and assign auctions from all sellers.
                                            </p>
