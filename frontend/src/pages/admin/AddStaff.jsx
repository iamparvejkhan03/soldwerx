...
import { UserPlus, Mail, Lock, Phone, User, ArrowLeft, Save, X, Shield, Users, Gavel, Hand, Banknote, DollarSign, Tags, Video, MessageSquare, Settings, LayoutDashboard, PercentCircle, Handshake, MessageSquareLock, BriefcaseBusiness, Store, MessageCircle, BanknoteArrowDown, BanknoteArrowUp, ShieldUser, CalendarDaysIcon } from "lucide-react";
...
const AddStaff = () => {
    ...
    const permissionOptions = [
        ...
        { value: "manage_offers", label: "Manage Offers", icon: <Handshake size={16} /> },
        { value: "manage_transactions", label: "Manage Buyer Payments", icon: <BanknoteArrowUp size={16} /> },
        ...
        { value: "manage_admins", label: "Manage Staff", icon: <ShieldUser size={16} /> },
        { value: "manage_tax", label: "Manage Tax", icon: <PercentCircle size={16} /> },
        { value: "manage_sell_requests", label: "Manage Consultations", icon: <BriefcaseBusiness size={16} /> },
        { value: "manage_communications", label: "Manage Communications", icon: <MessageSquareLock size={16} /> },
        { value: "manage_liquidations", label: "Manage Liquidations", icon: <Store size={16} /> },
        { value: "manage_comments", label: "Manage Comments", icon: <MessageCircle size={16} /> },
        { value: "manage_payouts", label: "Manage Seller Payouts", icon: <BanknoteArrowDown size={16} /> },
        { value: "manage_events", label: "Manage Events", icon: <CalendarDaysIcon size={16} /> },
    ];
