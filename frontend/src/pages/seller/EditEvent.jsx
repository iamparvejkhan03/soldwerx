            ...
            <div className="bg-white rounded-lg p-6 max-w-md mx-4">
                <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold">
                        {isEdit ? 'Updating Your Event' : 'Creating Your Event'}
                    </h3>
                </div>
...
function EditEvent() {
    ...
    const removeDocument = (index, isExisting = false) => {
        if (isExisting) {
            ...
            const newCaptions = [...documentCaptions];
            newCaptions.splice(uploadedDocuments.length - 1, 1);
            setDocumentCaptions(newCaptions);
        }
    };
    ...
    const updateEventHandler = async (eventData) => {
        try {
            ...
            existingDocuments.forEach((doc, index) => {
                // We don't need to send existing docs again, only their captions
            ...
            uploadedDocuments.forEach((doc, index) => {
                ...
                formData.append('documentCaptions', documentCaptions[existingDocuments.length + index] || '');
            });
                    ...
                    <SellerContainer>
                        <div className="pt-16 md:py-7">
                            <div className="flex items-center gap-3 mb-5">
                                <button
                                    onClick={() => navigate('/seller/events/all')}
