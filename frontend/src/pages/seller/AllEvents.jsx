...
function AllEvents() {
    ...
    const fetchEvents = async (page = 1, search = searchTerm, statusFilter = filter) => {
        setLoading(true);
        try {
            const { data } = await axiosInstance.get(`/api/v1/events/user/my-events`, {
                params: {
                    page,
                    limit: 10,
                    search,
    ...
    const handleEditEvent = (event) => {
        navigate(`/seller/events/edit/${event._id}`);
    };
                ...
                <SellerContainer>
                    <div className="max-w-full pt-16 pb-7 md:pt-0">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold my-5">My Events</h2>
                            </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div className="flex-1">
                                <div className="relative">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Search your events by title, location..."
