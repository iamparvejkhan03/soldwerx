        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 max-w-md mx-4">
                <div className="flex items-center mb-4">
                    ...
                    <h3 className="text-lg font-semibold">Creating Your Event</h3>
                </div>
...
// Available Auctions Component - For selecting auctions to assign
const AvailableAuctions = ({ auctions, selectedAuctions, onToggleAuction, loading }) => {
    if (loading) {
        return <div className="text-center py-8 text-gray-500">Loading your auctions...</div>;
    }

    if (auctions.length === 0) {
        return (
            <div className="text-center py-8 text-gray-500">
                <p>You don't have any auctions to assign.</p>
                <p className="text-sm mt-2">Create an auction first, then come back to assign it to this event.</p>
            </div>
        );
    }
...
function CreateEvent() {
    ...
    // Fetch seller's auctions for assignment
    useEffect(() => {
        const fetchAuctions = async () => {
            try {
                ...
                if (data.success) {
                    // Only show auctions that are not already assigned to other events? 
                    // We'll handle this on the backend later
                    setAvailableAuctions(data.data.auctions);
                }
            } catch (error) {
    ...
    const createEventHandler = async (eventData) => {
        try {
            ...
            uploadedDocuments.forEach((doc, index) => {
                ...
                formData.append('documentCaptions', documentCaptions[index] || '');
            });
                ...
                <div className="w-full relative">
                    ...
                    <SellerContainer>
                        <div className="pt-16 md:py-7">
                            <h1 className="text-3xl md:text-4xl font-bold mb-5">Create Event</h1>
                            ...
                            <form onSubmit={handleSubmit(createEventHandler)} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-6">
                                            ...
                                            <RTE
                                                ...
                                                placeholder="Describe the event, what to expect, special guests, etc..."
                                            />
                                                    ...
                                                    {uploadedDocuments.map((doc, index) => (
                                                        <div key={`new-doc-${index}`} className="bg-gray-50 p-3 rounded-lg">
                                                            ...
                                                            {/* <input
                                                                ...
                                                                onChange={(e) => handleDocumentCaptionChange(index, e.target.value)}
                                    ...
                                    <div>
                                        ...
                                        <div className="mb-4">
                                            <p className="text-gray-600">
                                                ...
                                                Selected auctions will be displayed together when users view this event.
                                            </p>
                                        ...
                                        <div className="mb-6">
                                            <label htmlFor="termsAgreed" className="flex items-start">
                                                ...
                                                <span className="text-sm font-medium text-secondary">
                                                    I confirm that the information provided is accurate and I have the right to create this event
                                                </span>
                                            </label>
